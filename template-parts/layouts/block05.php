<div class="uk-position-relative block05 uk-background-norepeat uk-background-cover" data-src="images/bg2.png" uk-img uk-height-viewport="" uk-parallax="bgy: -200">
    ...
    <div class="uk-section-xsmall uk-position-relative uk-position-z-index">
        <div class="uk-container uk-container-small">
            ...
            <h1 class="uk-h1 uk-margin-remove-top uk-text-center block05__title mb-20 mb-33-m">NGÀNH CÔNG NGHỆ THÔNG TIN</h1>
            ...
            <h3 class="block05__title1 uk-h3 uk-margin-remove uk-text-center uk-text-uppercase">Xét tuyển điểm Học bạ THPT Top50 toàn quốc</h3>
        </div>
    </div>
</div>